...
<p>
  <img src="https://skillicons.dev/icons?i=react,nextjs,tailwind,nodejs,express,mongodb,redux,sass,python,git,postman,postgres,ts,js,html,css,linux,firebase,jenkins,kubernetes,docker,gitlab,aws,graphql" />
</p>
